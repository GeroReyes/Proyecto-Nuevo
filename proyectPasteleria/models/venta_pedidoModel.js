...
class venta_pedido {
    ...
    static async update(id, data) {
        const { pago_total_pedido, empleado_id, cliente_id, metodo_pago_id } = data;
        const result = await pool.query(
            'UPDATE venta_pedido SET pago_total_pedido = $1, empleado_id = $2, cliente_id = $3, metodo_pago_id = $4, updated_at = current_timestamp WHERE id_pedido = $5 AND delete_at IS NULL RETURNING *', 
