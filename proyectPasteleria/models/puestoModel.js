...
class puesto {
    ...
    static async update(id, data) {
        ...
        const result = await pool.query(
            'UPDATE puesto SET  nombre_puesto = $1, sueldo = $2, hora_entrada = $3, hora_salida = $4, update_at = current_timestamp WHERE id = $5 AND delete_at IS NULL RETURNING *', 
    ...
    static async delete(id) {
        const result = await pool.query('UPDATE puesto SET delete_at = current_timestamp WHERE id = $1 RETURNING *', [id]);
