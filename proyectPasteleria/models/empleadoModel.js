...
class Empleado {
    ...
    static async update(id, data) {
        const { nombre_empleado, primer_apellido, segundo_apellido, numero_telefono, fecha_nacimiento, fecha_ingreso, usuarioId, puestoId } = data;
        const result = await pool.query(
            'UPDATE empleado SET nombre_empleado = $1, primer_apellido = $2, segundo_apellido = $3, numero_telefono = $4, fecha_nacimiento = $5, fecha_ingreso = $6, usuario_id = $7, puesto_id = $8, update_at = current_timestamp WHERE id_empleados = $9 AND delete_at IS NULL RETURNING *', 
